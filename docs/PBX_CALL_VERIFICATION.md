...
1. Back up WordPress and deploy plugin version 1.4.0. Activation/update creates and verifies the plugin-owned challenge, contact, consent-audit, replay, event, rate, and job tables. Do not continue if WordPress reports the migration/recovery-schedule gate as incomplete.
