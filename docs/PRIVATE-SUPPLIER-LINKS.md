...
خروجی `list` فقط شناسهٔ داخلی، نوع پلتفرم، منبع، وضعیت، زمان‌ها و وجود
نشانی/یادداشت را گزارش می‌کند. نشانی فروشنده، عنوان منبع، نام فروشنده، کد
فروشنده، نام سایت و متن یادداشت در خروجی WP-CLI چاپ نمی‌شوند؛ مشاهدهٔ کامل این اطلاعات
فقط از پنل مدیریت محصول انجام می‌شود.
