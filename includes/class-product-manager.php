    ...
    private function format_product_data($product, $depth, $list_context, $lookup_price_ranges) {
        ...
        try {
            ...
            $data = array(
                ...
                'patris_price_source_currency' => $product->get_meta('_digitalogic_patris_price_source_currency', true),
                'patris_price_source_kind'     => $product->get_meta('_digitalogic_patris_price_source_kind', true),
                ...
                'patris_price_rounding_digits' => $product->get_meta('_digitalogic_patris_price_rounding_digits', true),
                'patris_price_rounding_mode'   => $product->get_meta('_digitalogic_patris_price_rounding_mode', true),
