...
final class Digitalogic_Product_Column_Schema {
	...
	public static function catalog_columns( $warehouses = array() ) {
		...
		return array_merge(
			...
			array(
				...
				self::catalog_column( 'partner_price_irr', 'Partner Price (IRR)', 'قیمت همکار (ریال)', 'number' ),
				self::catalog_column( 'price_source_amount', 'Selected Price Amount', 'مبلغ منبع قیمت منتخب', 'number' ),
				self::catalog_column( 'price_source_currency', 'Selected Price Currency', 'ارز منبع قیمت منتخب', 'text' ),
				self::catalog_column( 'price_source_kind', 'Selected Price Source', 'نوع منبع قیمت منتخب', 'text' ),
				self::catalog_column( 'price_rounding_digits', 'Rounding Digits', 'تعداد ارقام گرد کردن', 'integer' ),
				self::catalog_column( 'price_rounding_mode', 'Rounding Mode', 'روش گرد کردن', 'text' ),
	...
	public static function workbook_columns( $warehouses = array() ) {
		$columns = array(
			...
			self::workbook_column( 'partner_price_irr', 'Partner Price (IRR)', 'قیمت همکار (ریال)', 'number', false, '', array(), 18 ),
			self::workbook_column( 'price_source_amount', 'Selected Price Amount', 'مبلغ منبع قیمت منتخب', 'number', false, '', array(), 20 ),
			self::workbook_column( 'price_source_currency', 'Selected Price Currency', 'ارز منبع قیمت منتخب', 'text', false, '', array(), 20 ),
			self::workbook_column( 'price_source_kind', 'Selected Price Source', 'نوع منبع قیمت منتخب', 'text', false, '', array(), 20 ),
			self::workbook_column( 'price_rounding_digits', 'Rounding Digits', 'تعداد ارقام گرد کردن', 'integer', false, '', array(), 18 ),
			self::workbook_column( 'price_rounding_mode', 'Rounding Mode', 'روش گرد کردن', 'text', false, '', array(), 20 ),
