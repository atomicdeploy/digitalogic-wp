...
final class Digitalogic_Product_Column_Schema {
	...
	public static function workbook_columns( $warehouses = array() ) {
		$columns = array(
			...
			self::workbook_column( 'patris_code', 'Product Code', 'کد کالا', 'text', false, '', array( 'Code', 'Patris Code' ), 20 ),
			...
			self::workbook_column( 'foreign_currency', 'Source Foreign Currency', 'ارز خارجی منبع', 'text', true, 'patris_foreign_currency', array(), 18 ),
			self::workbook_column( 'foreign_price', 'Source Foreign Price', 'قیمت ارزی منبع', 'number', true, 'patris_foreign_price', array(), 18 ),
			self::workbook_column( 'weight_grams', 'Source Weight (g)', 'وزن منبع (گرم)', 'number', true, 'patris_weight_grams', array(), 18 ),
			self::workbook_column( 'patris_total_stock', 'Source Total Stock', 'موجودی کل منبع', 'number', true, 'patris_total_stock', array(), 20 ),
			self::workbook_column( 'patris_minimum_stock', 'Minimum Stock', 'حداقل موجودی', 'number', true, 'patris_minimum_stock', array(), 18 ),
			self::workbook_column( 'patris_location', 'Source Location', 'موقعیت منبع', 'text', true, 'patris_location', array(), 18 ),
			self::workbook_column( 'patris_final_price', 'Source Final Price', 'قیمت نهایی منبع', 'number', true, 'patris_final_price', array(), 20 ),
			self::workbook_column( 'price_status', 'Source Price Status', 'وضعیت قیمت منبع', 'text', false, '', array(), 20 ),
