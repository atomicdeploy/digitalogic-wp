	...
	private static function copy( $status, $is_fa, $context ) {
		...
		$persian = array(
			...
			401 => array(
				...
				'detail'  => 'پنل دیجیتالاجیک از همان نشست وردپرس شما استفاده می‌کند.',
			),
			403 => array(
			...
			404 => array(
				...
				'title'   => 'این صفحه دیجیتالاجیک در دسترس نیست',
			...
			503 => array(
				...
				'title'   => 'سرویس دیجیتالاجیک هنوز آماده نیست',
	...
	private static function context_copy( $status, $is_fa, $context ) {
		...
		$persian = array(
			...
			self::CONTEXT_UI_SETTINGS         => array(
				...
				'title'   => 'تنظیمات نمای دیجیتالاجیک محدود است',
				'detail'  => 'فقط مدیر وردپرس می‌تواند تنظیمات نمای دیجیتالاجیک را تغییر دهد.',
			),
			self::CONTEXT_COMMENT_GUARD       => array(
