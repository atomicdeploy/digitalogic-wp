...
class Digitalogic_Panel {
    ...
    private function translations_en() {
        return array(
			...
			'patrisProducts' => 'Current Patris products',
            ...
            'patrisPriceStatus'                       => 'Patris price status',
            ...
            'reportMissingInWooCommerce' => 'In Patris but missing in WooCommerce',
            'reportPositiveStockMissingInWooCommerce' => 'Positive-stock product missing in WooCommerce',
            'reportMissingInPatris' => 'In WooCommerce but missing in Patris',
    ...
    private function translations_fa() {
        return array(
            ...
            'priceSyncText' => 'جریان محاسبه قیمت کاتالوگ برای ارز، حمل، وزن، سود، و قیمت نهایی گرد شده.',
			...
			'patrisProducts' => 'محصولات فعلی کاتالوگ',
