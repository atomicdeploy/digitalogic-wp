...
Current source-built release: [v1.8.7](https://github.com/atomicdeploy/digitalogic-wp/releases/tag/v1.8.7).
...
[`SHA256SUMS`](https://github.com/atomicdeploy/digitalogic-wp/releases/download/v1.8.7/SHA256SUMS)
