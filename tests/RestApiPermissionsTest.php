...
final class RestApiPermissionsTest extends TestCase {
    ...
    public function test_every_route_has_the_expected_permission_policy() {
        ...
        $expected = array(
			...
			'GET /currency/requests/(?P<request_id>[a-zA-Z0-9._:-]{8,128})' => 'check_read_permission',
			'DELETE /currency/requests/(?P<request_id>[a-zA-Z0-9._:-]{8,128})' => 'check_write_permission',
			...
			'GET /google-sheets/catalog-revision' => 'check_read_permission',
			...
			'GET /pricing/sync/builds/(?P<build_id>build_[a-f0-9]{32})' => 'check_pricing_snapshot_permission',
			'DELETE /pricing/sync/builds/(?P<build_id>build_[a-f0-9]{32})' => 'check_pricing_snapshot_permission',
			'GET /pricing/sync/snapshots/(?P<snapshot_token>snap_[a-f0-9]{32})' => 'check_pricing_snapshot_permission',
			'GET /pricing/sync/snapshots/(?P<snapshot_token>snap_[a-f0-9]{32})/pages/(?P<page>\d+)' => 'check_pricing_snapshot_permission',
