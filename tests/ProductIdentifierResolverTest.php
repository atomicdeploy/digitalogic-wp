<?php
// phpcs:disable Squiz.Commenting.FunctionComment.Missing, Generic.Commenting.DocComment.MissingShort -- Legacy fixture methods use behavior-first names as their documentation.
...
final class ProductIdentifierResolverTest extends TestCase {
	...
	protected function setUp(): void {
		$GLOBALS['digitalogic_test_posts'] = array(
			601 => array(
				...
				'meta'      => array(
					'_sku'                             => 'SKU-601',
					'_digitalogic_patris_product_code' => 'PATRIS-601',
				),
			),
			602 => array(
				...
				'meta'        => array(
					'_sku'                             => 'SKU-602',
					'_digitalogic_patris_product_code' => 'PATRIS-602',
				),
			),
			603 => array(
				'post_type' => 'product',
				'meta'      => array( '_sku' => 'DUP-SKU' ),
			),
			604 => array(
				'post_type' => 'product_variation',
				'meta'      => array( '_sku' => 'DUP-SKU' ),
			...
			605 => array(
				'post_type' => 'product',
				'meta'      => array( '_digitalogic_patris_product_code' => 'DUP-PATRIS' ),
			),
			606 => array(
				'post_type' => 'product_variation',
				'meta'      => array( '_digitalogic_patris_product_code' => 'DUP-PATRIS' ),
			...
			607 => array(
				'post_type' => 'product',
				'meta'      => array( '_sku' => 'CROSS' ),
			),
			608 => array(
				'post_type' => 'product',
				'meta'      => array( '_digitalogic_patris_product_code' => 'CROSS' ),
			),
			609 => array(
				'post_type' => 'product',
				'meta'      => array( '_sku' => '00123' ),
			),
			610 => array(
				'post_type' => 'product',
				'meta'      => array(),
			...
			611 => array(
				'post_type'   => 'product',
				'post_status' => 'trash',
				'meta'        => array( '_sku' => 'TRASH-SKU' ),
			),
			612 => array(
				'post_type'   => 'product_variation',
				'post_status' => 'auto-draft',
				'meta'        => array( '_sku' => 'AUTO-SKU' ),
			),
			613 => array(
				'post_type' => 'product',
				'meta'      => array( '_sku' => '113001001' ),
			),
			614 => array(
				'post_type' => 'product',
				'meta'      => array( '_sku' => 'A113001001' ),
			),
			700 => array(
				'post_type' => 'post',
	...
	public function test_bulk_patris_resolution_uses_one_query_and_preserves_exact_ambiguity(): void {
		$resolved = $this->resolver->resolve_patris_codes(
			array( 'PATRIS-601', 'PATRIS-602', 'DUP-PATRIS', 'missing', 'PATRIS-601' )
		);

		$this->assertSame( 1, $GLOBALS['wpdb']->identifier_query_count );
		$this->assertSame( '601', $resolved['PATRIS-601']['woocommerce_id'] );
		$this->assertSame( '602', $resolved['PATRIS-602']['woocommerce_id'] );
		$this->assertSame( 'digitalogic_product_identifier_ambiguous', $resolved['DUP-PATRIS']->get_error_code() );
		$this->assertSame( array( '605', '606' ), $resolved['DUP-PATRIS']->get_error_data()['woocommerce_ids'] );
		$this->assertSame( 'digitalogic_product_identifier_not_found', $resolved['missing']->get_error_code() );
	}
	...
	public function test_invalid_or_non_product_explicit_ids_fail_without_fallback(): void {
		...
		$not_product = $this->resolver->resolve(
			array(
				'woocommerce_id' => '700',
				'sku'            => 'SKU-601',
			)
