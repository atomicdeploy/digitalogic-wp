...
// phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed -- Preserve the WordPress hook signature in this test fixture.
function apply_filters( $hook, $value, ...$arguments ) {
	return $value; }
$GLOBALS['l10n']['bridge-proof'] = new class() {
	public function translate( string $text ): string {
		return 'WordPress: ' . $text; }
};
