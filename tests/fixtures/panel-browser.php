...
function panel_fixture_products() {
    return array(
        array(
            ...
            'patris_price_status' => 'priced',
            'patris_sale_policy' => 'preserve_sale',
            'patris_location' => 'A-12',
            'patris_updated_at' => '2026-07-21 12:00:00',
            'patris_warehouse_stock' => array('Tehran' => 12, 'Shenzhen' => 6),
            'stock_quantity' => '18',
        ...
        array(
            ...
            'patris_price_status' => 'priced_sale_preserved',
            'patris_sale_policy' => 'preserve_sale',
            'patris_location' => 'B-04',
            'patris_updated_at' => '2026-07-21 12:05:00',
            'patris_warehouse_stock' => array('Tehran' => 5, 'Shenzhen' => 2),
            'stock_quantity' => '7',
            'stock_status' => 'instock',
            'status' => 'publish',
            'image' => '',
...
function panel_fixture_reports($payload = array()) {
    $definitions = array(
        ...
        'missing_in_woocommerce' => array('در منبع کالا موجود اما در ووکامرس ناموجود', 'danger'),
    );
    $all_rows = array();
...
class Digitalogic_Panel {
    ...
    public function client_config() {
        ...
        return array(
            ...
            'warehouse_columns' => array(
                array('key' => 'warehouse_stock:Tehran', 'warehouse' => 'Tehran', 'label_en' => 'Warehouse Stock: Tehran', 'label_fa' => 'موجودی انبار: تهران'),
                array('key' => 'warehouse_stock:Shenzhen', 'warehouse' => 'Shenzhen', 'label_en' => 'Warehouse Stock: Shenzhen', 'label_fa' => 'موجودی انبار: شنژن'),
            ),
    ...
    private function translations($dir) {
        return array(
            ...
            'productDetails' => $dir === 'rtl' ? 'مشخصات محصول' : 'Product details', 'warehouseStock' => $dir === 'rtl' ? 'موجودی انبار' : 'Warehouse stock',
            'productTitle' => 'نام محصول', 'partNumber' => 'پارت نامبر', 'sku' => 'کد محصول', 'productType' => 'نوع محصول',
            'regularPrice' => 'قیمت عادی', 'salePrice' => 'قیمت فروش', 'effectivePrice' => 'قیمت فعال فروشگاه', 'patrisPriceStatus' => 'وضعیت قیمت منبع', 'patrisSalePolicy' => 'سیاست تخفیف', 'minPrice' => 'حداقل قیمت', 'maxPrice' => 'حداکثر قیمت',
            'weight' => 'وزن', 'patrisCurrency' => 'ارز API', 'patrisForeignPrice' => 'قیمت ارزی API',
            'patrisWeight' => 'وزن API', 'patrisFinalPrice' => 'قیمت نهایی API', 'patrisLocation' => 'محل API',
            'patrisUpdatedAt' => 'به‌روزرسانی API', 'stock' => 'موجودی', 'availability' => 'وضعیت موجودی', 'status' => 'وضعیت',
            ...
            'hideColumn' => $dir === 'rtl' ? 'پنهان کردن ستون' : 'Hide column', 'sortAsc' => $dir === 'rtl' ? 'مرتب سازی صعودی' : 'Sort ascending', 'sortDesc' => $dir === 'rtl' ? 'مرتب سازی نزولی' : 'Sort descending',
            ...
            'priceSync' => 'همگام‌سازی قیمت', 'priceSyncText' => 'مقایسه منبع و ووکامرس.',
            ...
            'refresh' => 'به‌روزرسانی', 'problemRows' => 'ردیف‌های مسئله‌دار', 'patrisProducts' => 'محصولات منبع', 'sourceCatalog' => 'منبع کالا',
            ...
            'reportMissingInWooCommerce' => $dir === 'rtl' ? 'در منبع کالا موجود اما در ووکامرس ناموجود' : 'In source but missing in WooCommerce',
            'reportMissingInPatris' => $dir === 'rtl' ? 'در ووکامرس موجود اما در منبع کالا ناموجود' : 'In WooCommerce but missing in source',
            ...
            'reportStalePrice' => $dir === 'rtl' ? 'قیمت منبع/API قدیمی' : 'Stale source/API price',
            ...
            'reportMismatchedName' => $dir === 'rtl' ? 'نام ووکامرس و منبع/API متفاوت است' : 'WooCommerce and source/API names differ',
