...
/** Validate pricing fields and revision; schema labels are descriptive metadata. */
...
function postPricingSettings_(config, request) {
  ...
  // The service emits digitalogic.pricing-coordinator-result without a version.
  // Trust the commit identity and typed payload, not optional schema metadata.
