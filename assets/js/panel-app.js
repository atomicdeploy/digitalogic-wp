(function(window, document) {
    ...
    function defaultProductColumns() {
        var columns = [
            ...
            {key: 'effective_price', labelKey: 'effectivePrice', field: 'effective_price', width: 142, visible: true, sortable: false, editable: false, numeric: true, filter: false, icon: 'dashicons-store', priority: 2},
            ...
            {key: 'patris_price_status', labelKey: 'patrisPriceStatus', field: 'patris_price_status', width: 190, visible: false, sortable: false, editable: false, filter: 'select', icon: 'dashicons-info-outline', priority: 3},
            {key: 'patris_sale_policy', labelKey: 'patrisSalePolicy', field: 'patris_sale_policy', width: 164, visible: false, sortable: false, editable: false, filter: 'select', icon: 'dashicons-shield', priority: 3},
        ...
        methods: {
            ...
            reportCategoryTitle: function(category) {
                var translationKeys = {
                    ...
                    zero_foreign_price: 'reportZeroForeignPrice',
                    missing_partner_price: 'reportMissingPartnerPrice',
                    null_partner_price: 'reportNullPartnerPrice',
                    zero_partner_price: 'reportZeroPartnerPrice',
                    missing_sale_price_source: 'reportMissingSalePriceSource',
                    null_sale_price_source: 'reportNullSalePriceSource',
                    missing_price_source: 'reportMissingPriceSource',
                    incomplete_price_source: 'reportIncompletePriceSource',
                    null_price_source: 'reportNullPriceSource',
                    invalid_price_source: 'reportInvalidPriceSource',
                    partner_price_fallback: 'reportPartnerPriceFallback',
                    sale_price_direct_fallback: 'reportSalePriceDirectFallback',
                    ...
                    missing_rounding_digits: 'reportMissingRoundingDigits',
                    null_rounding_digits: 'reportNullRoundingDigits',
                    missing_rounding_mode: 'reportMissingRoundingMode',
                    null_rounding_mode: 'reportNullRoundingMode',
                    invalid_rounding_policy: 'reportInvalidRoundingPolicy',
                    ...
                    pricing_provenance_drift: 'reportPricingProvenanceDrift',
